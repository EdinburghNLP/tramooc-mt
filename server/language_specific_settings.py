#tokenization rules for English input are slightly different for different language pairs

input_tokenizer = {}
input_tokenizer['en-bg'] = '-l en -a'
input_tokenizer['en-cs'] = '-l en -a'
input_tokenizer['en-de'] = '-l en -penn'
...
input_tokenizer['en-ru'] = '-l en -penn'
